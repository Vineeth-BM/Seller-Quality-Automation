/**
 * ActionHandler.gs - Handles direct actions via URL parameters
 * Enables direct response updates from links/buttons in sheets
 * @version 1.0
 * @lastModified 2025-04-18
 */

/**
 * Web app doGet function that handles both tracking pixels and action URLs
 * This allows us to create clickable links in the spreadsheet
 * 
 * Note: For this to work, deploy as described in WebhookModule.gs
 */
function doGet(e) {
  try {
